...
function BannerGallery() {
	...
	var c = jQuery("#main").offset().top;
	var d = jQuery("#banner .flexslider figcaption .pix-desc").offset().top;
	if (d >= 0 ) {


	jQuery("#banner .flexslider figcaption").css({
		"opacity": ((c-d)-a)/b
	})
	}
...
// event countdown
function px_event_countdown(year_event,month_event,date_event,hours,mints,id){
	"use strict";
